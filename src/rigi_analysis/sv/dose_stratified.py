...
def load_annotsv_files(annotsv_dir, chromosomes=None):
    ...
    for file_path in all_files:
        ...
        try:
            ...
            if chr_col is None:
                print(f"    WARNING: No chromosome column found")
                continue
    ...
    for file_path in sorted(dbs_files):
        ...
        try:
            ...
            if 'Pattern' in df.columns:
                ...
                print(f"    WARNING: No Pattern column found!")
                continue
...
def find_inv_dbs_pairs(inv_df, dbs_df, window_size=10):
    ...
    """
    print(f"\n{'=' * 70}")
    print(f"FINDING INV-DBS PAIRS WITH TEMPORAL CONCORDANCE")
...
def main():
    ...
    print(f"*** INV and DBS must have SAME dose AND timepoint ***")
