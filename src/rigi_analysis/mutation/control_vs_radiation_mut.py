...
def compare_genes_by_pattern(df, output_dir):
    ...
    print("    (at DIFFERENT positions - these are independent events)")
...
def main():
    ...
    compare_genes_by_pattern(df, output_dir)
    compare_by_dose(df, output_dir)
    compare_mutation_types(df, output_dir)
    analyze_late_crisis(df, output_dir)
